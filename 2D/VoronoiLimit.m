...
warning('off', 'map:polygon:noExternalContoursInVectorsToGPC');
...
try
    ...
    crslim_pol=[crslim(1) crslim(3)
        ...
        crslim(2) crslim(3)
        crslim(1) crslim(3)];
    if ~any(size(x)==1) || ~any(size(y)==1) || isscalar(x) || isscalar(y)
